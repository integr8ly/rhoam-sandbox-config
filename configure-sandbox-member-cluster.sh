...
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-base.yaml" | oc apply -n toolchain-host-operator -f -
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-baseextended.yaml" | oc apply -n toolchain-host-operator -f -
# Is this needed?
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-basedeactivationdisabled.yaml" | oc apply -n toolchain-host-operator -f -
oc process -f "${DIR}/sandbox/nstemplatetiers/rhoam-advanced.yaml" | oc apply -n toolchain-host-operator -f -
